...
type Address struct {
	...
	Encrypted     bool      `gorm:"type:tinyint(1);default:0;check:encrypted IN (0,1)" json:"encrypted"`
	EncryptionKey string    `gorm:"type:varchar(255);column:encryption_key" json:"encryption_key,omitempty"`
